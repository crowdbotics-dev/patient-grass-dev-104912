...
## Project Structure
    ...
    ├── patient_grass_dev_104912  # Django project configurations
...
1. Clone this repo and `cd patient_grass_dev_104912`
...
2. Clone this repo and `cd patient_grass_dev_104912`
